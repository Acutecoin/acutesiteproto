 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the acutecoin library.
 *
...
/** The complete proof needed to spend a acutecoin.
...
public:
	...
	/**Generates a proof spending a acutecoin.
	 *
	 ...
	 * @throw acutecoinException if the process fails
	 */
