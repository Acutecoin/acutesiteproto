 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the acutecoin library.
 *
...
public:
	 ...
	 * @throw      acutecoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		acutecoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A acutecoinException if the accumulator value is invalid.
	//  */
